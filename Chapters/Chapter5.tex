...
This formula has been used in the state-of-the-art similarity computation systems. As it has been used in \ref{mirage07} \ref{perfe11} \ref{fastmap12} we can be very confident on using it here too. Anyways, we must take into account several aspects. \\ 
