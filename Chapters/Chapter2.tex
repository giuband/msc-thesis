\chapter{Automatic music analysis techniques: state of the art} 
\label{Chapter2} 

\lhead{Chapter 2. \emph{Automatic music analysis techniques: state of the art}} 
...
\subsubsection*{Other relevant timbre descriptors}
