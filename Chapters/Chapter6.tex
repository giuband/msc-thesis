...
\end{itemize}
The RTP/RTSP have not been taken into account, for the use of Flash in webpages is generally discouraged. Furthermore, we had no experience with it, and it could have not been feasible to implement it within the inauguration of the exhibition.
